      ...
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20">
        <div className="flex-1">
          <div className="flex items-center justify-between mb-8 border-b border-gray-500/30 pb-6">
            ...
            <p className="text-lg md:text-xl text-gray-500/80">{getCartCount()} Artículos</p>
          </div>
                ...
                {Object.keys(cartItems).map((itemId) => {
                  ...
                  return (
                    <tr key={itemId}>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">Q{product.offerPrice}</td>
                      ...
                      <td className="py-4 md:px-4 px-1 text-gray-600">Q{(product.offerPrice * cartItems[itemId]).toFixed(2)}</td>
                    </tr>
                  );
                })}
              </tbody>
          ...
          <button onClick={()=> router.push('/all-products')} className="group flex items-center mt-6 gap-2 text-secondary-500">
            <Image
