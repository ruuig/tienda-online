        ...
        <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center mt-10 gap-4">
                        ...
                        <button onClick={() => { addToCart(productData._id); router.push(user ? '/cart' : '') }} className="w-full py-3.5 bg-secondary-500 text-white hover:bg-secondary-600 transition">
                            Comprar ahora
                        </button>
                    </div>
                </div>
            ...
            <div className="flex flex-col items-center">
                <div className="flex flex-col items-center mb-4 mt-16">
                    <p className="text-3xl font-medium">Productos <span className="font-medium text-secondary-500">Destacados</span></p>
