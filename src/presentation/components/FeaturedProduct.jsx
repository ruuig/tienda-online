...
const products = [
  ...
  {
    id: 3,
    image: assets.boy_with_tablet_image,
    title: "Potencia en Cada Píxel",
    description: "Descubre las últimas laptops para trabajo, juegos y más.",
  },
];
        ...
        {products.map(({ id, image, title, description }) => (
          <div key={id} className="relative group">
            ...
            <div className="group-hover:-translate-y-4 transition duration-300 absolute bottom-8 left-8 text-white space-y-2">
              ...
              <button className="flex items-center gap-1.5 bg-secondary-500 px-4 py-2 rounded text-white">
                Comprar ahora <Image className="h-3 w-3" src={assets.redirect_icon} alt="Icono de redirección" />
              </button>
            </div>
          </div>
        ))}
